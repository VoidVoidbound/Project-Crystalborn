...
public enum ModArmorMaterials implements ArmorMaterial {
    CRYSTAL("crystal", 37, new int[]{4, 9, 7, 4}, 30,
    SoundEvents.ARMOR_EQUIP_DIAMOND, 2.0f, 2.0f, () -> Ingredient.of(ModItems.CRYSTAL_INGOT.get()));
    ...
    public String getName() {
        return crystalborn.MOD_ID + ":" + this.name;
    }
