...
public class TerraCrystalTrunkPlacer extends TrunkPlacer {
    public static final Codec<TerraCrystalTrunkPlacer> CODEC = RecordCodecBuilder.create(TerraCrystalTrunkPlacerInstance ->
            trunkPlacerParts(TerraCrystalTrunkPlacerInstance).apply(TerraCrystalTrunkPlacerInstance, TerraCrystalTrunkPlacer::new));

    public TerraCrystalTrunkPlacer(int pBaseHeight, int pHeightRandA, int pHeightRandB) {
        super(pBaseHeight, pHeightRandA, pHeightRandB);
    }

    @Override
    protected TrunkPlacerType<?> type() {
        return ModTrunkPlacerTypes.TERRA_CRYSTAL_TREE_TRUNK_PLACER.get();
    }
