...
public class VoidCrystalTrunkPlacer extends TrunkPlacer {
    public static final Codec<VoidCrystalTrunkPlacer> CODEC = RecordCodecBuilder.create(VoidCrystalTrunkPlacerInstance ->
            trunkPlacerParts(VoidCrystalTrunkPlacerInstance).apply(VoidCrystalTrunkPlacerInstance, VoidCrystalTrunkPlacer::new));

    public VoidCrystalTrunkPlacer(int pBaseHeight, int pHeightRandA, int pHeightRandB) {
        super(pBaseHeight, pHeightRandA, pHeightRandB);
    }

    @Override
    protected TrunkPlacerType<?> type() {
        return ModTrunkPlacerTypes.VOID_CRYSTAL_TREE_TRUNK_PLACER.get();
    }
