...
public class ShardlingAnimationDefinitions {
    public static final AnimationDefinition SHARDLINGIDLE = AnimationDefinition.Builder.withLength(0.0417F).looping()
    ...
    public static final AnimationDefinition SHARDLINGWALKING = AnimationDefinition.Builder.withLength(0.0417F).looping()
            .addAnimation("body", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.0417F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
            ))
