...
public class PrismElkAnimationDefinitions {
    public static final AnimationDefinition PRISMELKWALKING = AnimationDefinition.Builder.withLength(2.5F).looping()
            ...
            .build();
    public static final AnimationDefinition PRISMELKIDLE = AnimationDefinition.Builder.withLength(1.0F).looping()
            .addAnimation("Leg1A", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
            ))
            .addAnimation("Leg2A", new AnimationChannel(AnimationChannel.Targets.ROTATION,
