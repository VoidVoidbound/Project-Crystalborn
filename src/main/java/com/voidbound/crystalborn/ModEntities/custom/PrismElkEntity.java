...
import com.voidbound.crystalborn.ModEntities.ai.PrismElkAttackGoal;
...
public class PrismElkEntity extends Animal {
    private static final EntityDataAccessor<Boolean> ATTACKING =
            SynchedEntityData.defineId(PrismElkEntity.class, EntityDataSerializers.BOOLEAN);

    public PrismElkEntity(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new PrismElkAttackGoal(this, 1D, true));
    ...
    public @Nullable AgeableMob getBreedOffspring(ServerLevel pLevel, AgeableMob pOtherParent) {
        return ModEntities.PRISMELK.get().create(pLevel);
    }
