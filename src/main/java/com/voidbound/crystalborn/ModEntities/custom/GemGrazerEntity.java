...
import com.voidbound.crystalborn.ModEntities.ai.GemGrazerAttackGoal;
...
public class GemGrazerEntity extends Animal {
    private static final EntityDataAccessor<Boolean> ATTACKING =
            SynchedEntityData.defineId(GemGrazerEntity.class, EntityDataSerializers.BOOLEAN);

    public GemGrazerEntity(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new GemGrazerAttackGoal(this, 1D, true));
        ...
        this.targetSelector.addGoal(1, new BrokenBlockAgroEvent(this, Set.of(ModBlocks.TERRA_CRYSTAL.get()), 15));
    }
    ...
    public @Nullable AgeableMob getBreedOffspring(ServerLevel pLevel, AgeableMob pOtherParent) {
        return ModEntities.GEMGRAZER.get().create(pLevel);
    }
