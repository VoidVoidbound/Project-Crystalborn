...
import com.voidbound.crystalborn.ModEntities.ai.ShardlingAttackGoal;
...
public class ShardlingEntity extends Animal {
    private static final EntityDataAccessor<Boolean> ATTACKING =
            SynchedEntityData.defineId(ShardlingEntity.class, EntityDataSerializers.BOOLEAN);

    public ShardlingEntity(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new ShardlingAttackGoal(this, 1D, true));
    ...
    public @Nullable AgeableMob getBreedOffspring(ServerLevel pLevel, AgeableMob pOtherParent) {
        return ModEntities.SHARDLING.get().create(pLevel);
    }
