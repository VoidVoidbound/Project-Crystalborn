...
import com.voidbound.crystalborn.ModEntities.animations.PrismElkAnimationDefinitions;
...
public class PrismElkModel<T extends Entity> extends HierarchicalModel<T> {
    ...
    public PrismElkModel(ModelPart root) {
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.animateWalk(PrismElkAnimationDefinitions.PRISMELKWALKING, limbSwing, limbSwingAmount, 1f, 2.5f);
        this.animate(((PrismElkEntity) entity).idleAnimationState, PrismElkAnimationDefinitions.PRISMELKIDLE, ageInTicks, 1f);
        this.animate(((PrismElkEntity) entity).attackAnimationState, PrismElkAnimationDefinitions.PRISMELKWALKING, ageInTicks, 1f);
