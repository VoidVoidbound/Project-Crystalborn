...
import com.voidbound.crystalborn.worldgen.ModBiomeModifiers;
import com.voidbound.crystalborn.worldgen.ModConfiguredFeatures;
import com.voidbound.crystalborn.worldgen.ModPlacedFeatures;
...
//            .add(Registries.BIOME, ModBiomes::boostrap)
    ...
    public ModWorldGenProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
        super(output, registries, BUILDER, Set.of(crystalborn.MOD_ID));
    }
}
