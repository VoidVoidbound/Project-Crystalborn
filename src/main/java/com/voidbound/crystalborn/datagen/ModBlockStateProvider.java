...
//import com.voidbound.crystalborn.ModBlocks.ModBlocks;
//import com.voidbound.crystalborn.ModBlocks.custom.CornCropBlock;
//import com.voidbound.crystalborn.ModBlocks.custom.StrawberryCropBlock;

import java.util.function.Function;

public class ModBlockStateProvider extends BlockStateProvider {
    public ModBlockStateProvider(PackOutput output, ExistingFileHelper exFileHelper) {
        super(output, crystalborn.MOD_ID, exFileHelper);
    }
...
//                new ResourceLocation(crystalborn.MOD_ID, "block/stripped_pine_log_top"));
...
//        saplingBlock(ModBlocks.PINE_SAPLING);
    ...
    private void blockItem(RegistryObject<Block> blockRegistryObject) {
        simpleBlockItem(blockRegistryObject.get(), new ModelFile.UncheckedModelFile(crystalborn.MOD_ID +
...
//                new ResourceLocation(crystalborn.MOD_ID, "block/" + textureName + state.getValue(((StrawberryCropBlock) block).getAgeProperty()))).renderType("cutout"));
//
//        return models;
//    }
//
...
//                new ResourceLocation(crystalborn.MOD_ID, "block/" + textureName + state.getValue(((CornCropBlock) block).getAgeProperty()))).renderType("cutout"));
//
//        return models;
//    }
